...
To help fix that, I interviewed Gaelen Ash, once-salt for the hotel and service workers’ union [UNITE HERE!](https://unitehere.org/). UNITE HERE! is a particularly relevant union because it maintains a policy that all of its staff have to start out as a salt before they can be full organizers.
...
To start, the term “salting” comes from the phrase “rubbing salt in the wound”, which is another way to describe agitating a workplace. That phrase is a bit of a misdirection, however, since based off Gaelen’s experience, salts very rarely agitate anyone.

 

The goal of salts today is to be a sponge. To look completely non-threatening and mundane, to be as friendly and helpful to their coworkers as possible, and to absorb every piece of information they can find. They go to every after-work party and hang out with everyone at their job as much as possible. Everything they learn—a workplace’s social dynamics, coworkers, common issues—gets passed along to the organizers as their union prepares its campaign.
...
The second route is to organize an already-unionized workplace. Stagnant and non-militant unions need organizing as much as anywhere else, which can be done by getting militant rank-and-file members elected to union office positions. According to Gaelen, this kind of organizing is the most fun. Workers are pissed about their conditions everywhere, even in a union, and can be agitated, educated, and organized. There’s also no risk. Union leadership can’t do anything to shut you up. You pay dues. You’re invincible.
